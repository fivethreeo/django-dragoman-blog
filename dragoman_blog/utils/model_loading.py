...
def get_model_string(model_name, setting_format='DRAGOMAN_BLOG_%s_MODEL', fallback_format='dragoman_blog.%s'):
    """
...
def get_dragoman_model_string(model_name):
    return get_model_string(model_name, setting_format='DRAGOMAN_BLOG_%s_MODEL', fallback_format='dragoman_blog.%s')